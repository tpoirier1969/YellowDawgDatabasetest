...
const COLOR_SOLID_OPTIONS=FishingVocab.COLOR_SOLID_OPTIONS || ['Black','Blue','Brown','Chartreuse','Copper','Cream','Gold','Gray','Green','Orange','Pink','Purple','Red','Silver','Tan','White','Yellow'];
...
const COLOR_OPTIONS=FishingVocab.COLOR_OPTIONS || ['Black','Blue','Brown','Chartreuse','Copper','Cream','Gold','Gray','Green','Orange','Pink','Purple','Red','Silver','Tan','White','Yellow','Black / Gold','Black / Silver','Blue / Silver','Brown / Orange','Fire Tiger','Glow','Gold / Red','Natural','Perch','Rainbow','Silver / Black','Silver / Blue','Silver / Chartreuse','White / Chartreuse','White / Pink','White / Red','Barred','Cinnamon','Dun','Flash','Holographic','Iridescent','Opalescent','Pearl','Peacock','Peacock Herl','Prismatic','UV Olive','UV Pearl','UV Pink','Variegated'];
const FLY_MATERIAL_COLOR_OPTIONS=['Barred','Cinnamon','Dun','Flash','Holographic','Iridescent','Opalescent','Pearl','Peacock','Peacock Herl','Prismatic','UV Olive','UV Pearl','UV Pink','Variegated'];
