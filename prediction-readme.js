...
window.FishingPredictionReadme=(function(){
  const html=`
    ...
    <p>This screen is the staging area for the prediction engine. The goal is not just a pretty summary. It is meant to look at your logged trips and identify both basic patterns and harder-to-see hidden relationships in the data.</p>
